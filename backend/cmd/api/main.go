...
func main() {
	...
	storeCategoryService := services.NewStoreCategoryService(db, cache, storageRegistry)
	storeCategoryHandler := handlers.NewStoreCategoryHandler(storeCategoryService)
	v1.GET("/store-categories", storeCategoryHandler.ListActive)
	admin.GET("/store-categories", storeCategoryHandler.List)
	admin.POST("/store-categories", storeCategoryHandler.Create)
	admin.PUT("/store-categories/:id", storeCategoryHandler.Update)
	admin.PUT("/store-categories/:id/active", storeCategoryHandler.SetActive)
	admin.DELETE("/store-categories/:id", storeCategoryHandler.Delete)

	productCategoryService := services.NewProductCategoryService(db, cache, storageRegistry)
	productCategoryHandler := handlers.NewProductCategoryHandler(productCategoryService)
	v1.GET("/store-categories/:id/product-categories", productCategoryHandler.ListActive)
	...
	admin.PUT("/product-categories/:id/active", productCategoryHandler.SetActive)
	admin.DELETE("/product-categories/:id", productCategoryHandler.Delete)

	categoryRequestService := services.NewCategoryRequestService(db, auditService, storeCategoryService, productCategoryService)
	categoryRequestHandler := handlers.NewCategoryRequestHandler(categoryRequestService)
	admin.GET("/category-requests", categoryRequestHandler.List)
	admin.POST("/category-requests/:id/approve", categoryRequestHandler.Approve)
	admin.POST("/category-requests/:id/reject", categoryRequestHandler.Reject)
	vendorOwn.POST("/:id/category-requests", categoryRequestHandler.Submit)
	vendorOwn.GET("/:id/category-requests", categoryRequestHandler.ListOwn)
