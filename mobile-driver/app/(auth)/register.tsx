...
// Blueprint §11.D1/§9: Register (new numbers only) — reached only when
// verify-otp returned register_required. Note: registration through this
// flow creates a plain `user` role account server-side; a genuinely new
// driver phone number is expected to be provisioned as `driver` by an
// admin (blueprint §11.A6 "create/verify/activate/deactivate driver")
// before ever reaching this app, so in practice this screen is a rare path
// covering the same contract the backend exposes to every role.
