...
const LOCALE_KEY = 'meryata_driver_locale'
...
// directionMatches aligns I18nManager with the persisted locale at startup
// so the very first render is in the right direction.
